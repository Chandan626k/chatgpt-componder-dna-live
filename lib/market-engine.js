...
export async function analyze(input) {
  ...
  // Chart data is the critical path. Fundamental summary is optional so a
  // temporary Yahoo quoteSummary failure cannot make the entire analysis blank.
  ...
  if (summaryResult.status === 'rejected') {
    console.warn('[analyze] Yahoo fundamentals unavailable; continuing with price/technical data:', summaryResult.reason?.message || summaryResult.reason);
  }
